...
class prestamosClase{
    constructor(prestamoInicial, cuotasPagas, nombre) {
        this.prestamoInicial = prestamoInicial
...
function calcularPrestamo(prestamoInicial, cuotasPagas){
    ...
    const prestamo = new prestamosClase (prestamoInicial, cuotasPagas, nombre)
    prestamosArray.push(prestamo)
    let nombreDesarrollador = "David"
    function desarrollador (nombreDesarrollador){
        let eventoCoincidencia = prestamosArray.find(prestamo => prestamo.nombre === nombreDesarrollador)
        if (eventoCoincidencia){
            console.log("Usted es el desarrollador!!")
        }
    }
